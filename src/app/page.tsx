    ...
    <div className="page-frame">
      <section className="hero">
        <div>
          ...
          <p className="hero-copy">Stewardship Ledger is a public casebook for high-autonomy systems. Read the research behind the claim, model the trade-offs, name the people who can stop the action, and leave a seal another person can replay.</p>
          <div className="hero-actions" style={{ marginTop: 28 }}><Link className="button-primary" href="/atlas">Open the evidence atlas <ArrowUpRight size={17} aria-hidden="true" /></Link><Link className="button-secondary" href="/ledger">Open the ledger <ArrowDownRight size={16} aria-hidden="true" /></Link><Link className="button-secondary" href="/method">Read the method <BookOpen size={16} aria-hidden="true" /></Link></div>
      ...
      <section className="section-block" id="jobs">
        <div className="section-heading"><div><span className="eyebrow">The usefulness test</span><h2 className="section-title">Four jobs. One shared trail.</h2></div><p className="section-lede">A safety tool is only useful when a person can change a decision with it. These are the actions the product is built around.</p></div>
        <div className="job-grid">
          <article className="job-card"><span className="job-number">01</span><h3>Read the evidence</h3><p>Start with primary papers, frontier reports, podcasts, commentary, and tools, then see what each source can and cannot establish.</p></article>
          <article className="job-card"><span className="job-number">02</span><h3>Model the system</h3><p>A builder can create a case, change the authority and safeguards, and see the score respond in the same record.</p></article>
          <article className="job-card"><span className="job-number">03</span><h3>Interrogate the trade-off</h3><p>An auditor can inspect every weighted factor, the public research signal, and the exact seal that links each revision.</p></article>
          <article className="job-card"><span className="job-number">04</span><h3>Let an agent help</h3><p>A coding agent can call the same REST/MCP tools to read, score, create, update, and synthesize cases without a private key.</p></article>
        </div>
      </section>
      ...
      <section className="section-block" id="signals">
        <div className="section-heading"><div><span className="eyebrow">Evidence, not vibes</span><h2 className="section-title">A live signal beside a durable decision.</h2></div><p className="section-lede">The evidence atlas separates primary research, first-party reports, practitioner commentary, and offline fallback before a synthesis is saved.</p></div>
        <SignalFeed />
      </section>
      ...
      <section className="section-block" id="features">
        ...
        <div className="feature-grid">
          <article className="feature-card"><span className="feature-icon"><BookOpen size={20} aria-hidden="true" /></span><h3>Evidence atlas</h3><p>Browse a source shelf with evidence grades, claims, limitations, topic links, commentary counterpoints, and a plain-language brief engine.</p></article>
